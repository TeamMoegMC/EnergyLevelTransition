...
public class LH {
    public static class Chat {
        public static final String
                ...
                , DBLUE = TextFormatting.DARK_BLUE.toString()
                , DGREEN = TextFormatting.DARK_GREEN.toString()
                , DCYAN = TextFormatting.DARK_AQUA.toString()
                , DRED = TextFormatting.DARK_RED.toString()
                , PURPLE = TextFormatting.DARK_PURPLE.toString()
                , ORANGE = TextFormatting.GOLD.toString()
                , GOLD = TextFormatting.GOLD.toString()
                , GRAY = TextFormatting.GRAY.toString()
                , DGRAY = TextFormatting.DARK_GRAY.toString()
                , BLUE = TextFormatting.BLUE.toString()
                , GREEN = TextFormatting.GREEN.toString()
                , CYAN = TextFormatting.AQUA.toString()
                , RED = TextFormatting.RED.toString()
                , PINK = TextFormatting.LIGHT_PURPLE.toString()
