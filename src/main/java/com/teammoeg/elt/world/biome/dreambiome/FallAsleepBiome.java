...
public class FallAsleepBiome extends ELTBiome {
    public FallAsleepBiome() {
        super(Biome.RainType.RAIN, Biome.Category.ICY, 0.125F, 0.05F, 0.8F, 0.4F,
                ...
                (new BiomeGenerationSettings.Builder()).surfaceBuilder(ConfiguredSurfaceBuilders.STONE).build()
        );
    }
}
