...
public class MountainDreamBiome extends ELTBiome {
    public MountainDreamBiome() {
        super(Biome.RainType.RAIN, Biome.Category.EXTREME_HILLS, 1F, 0.55F, 0.2F, 0.4F,
                ...
                (new BiomeGenerationSettings.Builder()).surfaceBuilder(ConfiguredSurfaceBuilders.GRASS).
                        addFeature(GenerationStage.Decoration.TOP_LAYER_MODIFICATION, Features.FREEZE_TOP_LAYER).
                        addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, Features.ORE_INFESTED).build()
        );
    }
}
